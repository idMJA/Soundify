...
import { getVideoStreams as getInvidiousStreams, getBestAudioStream as getInvidiousBestAudio } from "../invidious/route";
import { getVideoStreams as getPipedStreams, getBestAudioStream as getPipedBestAudio } from "../piped/route";
...
export async function POST(request: NextRequest) {
  try {
    ...
    try {
      ...
      try {
        // First try with Invidious
        console.log("Trying to get stream with Invidious API");
        ...
        try {
          console.log("Trying to get stream with Piped API");
