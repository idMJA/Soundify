						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
							<div className="flex flex-col items-center text-center">
								...
								<p className="text-muted-foreground">
									Listen to millions of songs for free, without any limitations
									or subscriptions.
								</p>
							</div>
							<div className="flex flex-col items-center text-center">
							...
							<div className="flex flex-col items-center text-center">
								...
								<p className="text-muted-foreground">
									Create your own playlists and discover new music tailored to
									your taste.
								</p>
							</div>
						</div>
				...
				<section className="bg-gradient-to-r from-primary to-accent text-primary-foreground py-16 px-4">
					<div className="container mx-auto max-w-4xl text-center">
						...
						<p className="text-lg mb-8 opacity-90">
							Join millions of users and enjoy unlimited music streaming with
							Soundify.
						</p>
						<Link
							href="/player"
					...
					<div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-8">
						<div className="flex flex-col items-center md:items-start">
							...
							<p className="text-muted-foreground text-sm">
								© 2023 Soundify. All rights reserved.
							</p>
						</div>
